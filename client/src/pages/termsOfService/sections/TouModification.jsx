const TouModification = () => {
    return (
        <div id="touModification" className="flex flex-col sm:p-10 p-1">
            <div className="text-xl xxs:text-3xl font-bold text-gray-700 transition duration-300 md:text-4xl dark:text-white">
            Terms of Use Modification
            </div>
            <div className="mt-10 dark:text-white sm:text-justify text-left">
...
export default TouModification;