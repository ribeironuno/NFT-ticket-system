...
const CreateStructureModal = ({ setOpen, createStructure }) => {

    const [structName, setStructName] = useState("")

    function prepareCreateStructure() {

        if (createStructure(structName)) {
            setOpen(false)
        }
    }
                        ...
                        <div className="inline-block bg-white dark:bg-gray-800 align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className="sm:col-span-3">
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200">Structure name</label>
                                        <input
                                            type="text"
                                            value={structName}
                            ...
                            <div className="mt-8 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <button
                                    ...
                                    onClick={() => prepareCreateStructure()}>
                                    Create
                                </button>
                                <button
                                    type="button"
