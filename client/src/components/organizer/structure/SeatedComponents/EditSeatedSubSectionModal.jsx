...
const EditSeatedSubSectionModal = ({ setOpen, editSubSeatedSectionFunction, sectionToEdit }) => {
    const [sectionRow, setsectionRow] = useState(sectionToEdit.row)
    const [capacity, setCapacity] = useState(sectionToEdit.capacity)

    function editNonSeatedSection() {
        if (editSubSeatedSectionFunction(sectionRow, capacity)) {
            setsectionRow("")
            setCapacity("")
            setOpen(false)
        }
                        ...
                        <div className="inline-block bg-white dark:bg-gray-800 align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className='w-full flex justify-start flex-wrap'>
                                    <div className="mx-auto flex-shrink-0 mb-6 flex items-center justify-center 
                                        ...
                                        <div className="flex justify-center flex-wrap w-full ">
                                            ...
                                            <div className="w-full pt-6">
                                                ...
                                                <input
                                                    type="text"
                                                    value={sectionRow}
                                                    onChange={(e) => { setsectionRow(e.target.value) }}
                            ...
                            <div className="mt-8 sm:mt-4 sm:flex sm:flex-row-reverse">
                                <button
                                    ...
                                    font-medium text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm"
                                    onClick={() => editNonSeatedSection()}>
                                    Edit
                                </button>
                                <button
                                    type="button"
...
export default EditSeatedSubSectionModal